...
# DISPLAY=:0 DEVID=`xinput list --id-only "pointer:Lenovo ThinkPad Compact USB Keyboard with TrackPoint"`
DISPLAY=:0 /usr/bin/xinput set-button-map "pointer:Lenovo ThinkPad Compact USB Keyboard with TrackPoint" 1 0 3 4 5 6 7 &>> /tmp/xinput
